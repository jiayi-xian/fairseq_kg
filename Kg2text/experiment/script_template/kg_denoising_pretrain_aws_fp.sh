...
PRETRAIN=${EFS}/models/mbart50.pretrained/model_wtags0/test/model.pt
...
restore_file=$checkpoint_dir/checkpoint1.pt
...
CUDA_VISIBLE_DEVICES=${CUDA} python ${FAIRSEQ}/train.py ${DATADIR} \
    ...
    --save-interval-updates 10000 --keep-interval-updates 100 --seed 222  \
