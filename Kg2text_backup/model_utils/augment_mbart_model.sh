...
PRETRAIN=${EFS}/models/mbart50.pretrain/model_wtags0/model.pt

python $KG2TEXT/model_utils/augment_mbart_model.py \
   /home/xianjiay/efs-storage/fairseq/Kg2text/model/mbart50.pretrained \
   --tgt-dict "/home/xianjiay/efs-storage/fairseq/Kg2text/data-bin/dict.mbart50_wtags.txt" \
   --save-to "/home/xianjiay/efs-storage/fairseq/Kg2text/model/mbart50.pretrained/model_wtags0"