...
load_data_dir=${DATADIR}/dataset_kg2text/$dataset/en_XX/tagged
save_data_dir=${DATADIR}/dataset_kg2text/$dataset/en_XX
SRC=kg
TGT=text
...
fairseq-preprocess \
    ...
    --srcdict $DATADIR/dataset_denoising/kgtext_wikidata/dict.txt \
